  ...
  return (
    <div id={blockTourId} className="bg-white rounded-[22px] shadow-sm border border-[#e8e8ed] overflow-hidden print:overflow-visible mb-3 mx-3">
      ...
      <div className="block lg:hidden print:hidden bg-white divide-y divide-[#e8e8ed]">
        {/**
         * Fatura do primeiro mês do plano: um aviso, no topo, e só.
         *
         * Ela é feita de compras anteriores ao plano — quem começa em setembro
         * está pagando agosto. Essas compras não entram na fila (o corte em
        ...
        {category === CategoryType.CREDIT_CARD && mobileMonthIdx === 0
          ...
          <div className="px-4 py-3 bg-[#f5f5f7]">
            <div className="flex items-start gap-2">
              <i className="fas fa-circle-info text-[#8e8e93] text-[13px] mt-px" />
              <p className="text-[11.5px] text-[#6e6e73] leading-relaxed">
                <span className="font-black text-[#1d1d1f]">Esta é a sua fatura de entrada.</span>{' '}
                São compras feitas antes do plano começar — não precisa categorizar nenhuma.
                O detalhamento começa nas compras deste mês, que caem na fatura do mês que vem.
              </p>
            </div>
          </div>
        )}
