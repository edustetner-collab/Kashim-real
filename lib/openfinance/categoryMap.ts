...
const CODE_MAP: Record<string, CategoryType> = {
  ...
  GROCERIES: CategoryType.FIXED_EXPENSE,
  ...
  GASSTATIONS: CategoryType.FIXED_EXPENSE,
  FOOD: CategoryType.PERSONAL_LEISURE,
  SUPERMARKET: CategoryType.FIXED_EXPENSE,
  RESTAURANT: CategoryType.PERSONAL_LEISURE,
